  ...
  protected void onStartAnimation() {
    ...
    animator.addListener(new Animator.AnimatorListener() {
      ...
      public void onAnimationStart(Animator animation) {
        Toast.makeText(WithListenerAnimationActivity.this, "Dog took off", Toast.LENGTH_SHORT)
            .show();
      }

      @Override
      public void onAnimationEnd(Animator animation) {
        Toast.makeText(WithListenerAnimationActivity.this, "Dog is on the moon", Toast.LENGTH_SHORT)
            .show();
        finish();
      }
