...
public class RocketAdapter extends RecyclerView.Adapter<RocketAdapter.RocketViewHolder> {
  ...
  private final List<RocketLaunchModule.RocketAnimationItem> mItems;
  private final Context mContext;

  public RocketAdapter(Context context, List<RocketLaunchModule.RocketAnimationItem> items) {
    super();
    mContext = context;
    mItems = items;
  }
